...
class RecorderWidget(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.check_compress = ModernCheckBox("自動壓縮影片"); self.check_compress.setChecked(True); self.check_compress.toggled.connect(self.save)
        self.check_keep_original = ModernCheckBox("保留原始檔"); self.check_keep_original.setChecked(False); self.check_keep_original.toggled.connect(self.save)
